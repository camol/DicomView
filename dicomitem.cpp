...
DicomItem::DicomItem(const dicom::DataSet &dset)
{
    ...
    //dset(dicom::TAG_SOP_CLASS_UID) >> SOP_Class_UID; brak typu
    //dset(dicom::TAG_SOP_INST_UID ) >> SOP_Instance_UID; brak typu
    ...
    //dset(dicom::TAG_INSTITUT_DEPT_NAME ) >> Institution_Name; brak typu
    ...
    //dset(dicom::TAG_PERF_PHYS_NAME ) >> Performing_Physicians_Name; brak typu
